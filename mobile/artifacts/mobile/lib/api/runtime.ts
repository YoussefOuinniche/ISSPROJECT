...
let resolvedBootstrapToken: string | null = null;
...
export function configureMobileApiRuntime() {
  ...
  setAuthTokenGetter(async () => getMobileAccessToken());
}
...
export async function resetStoredMobileAccessToken() {
