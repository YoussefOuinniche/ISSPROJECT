...
from ai_profile_extract_service import (
    AIProfileExtractServiceContext,
    AIProfileExtractServiceError,
    handle_extract_profile,
)
...
def get_ai_profile_extract_service(request: Request) -> AIProfileExtractServiceContext:
...
async def extract_profile_endpoint(
    ...
    service: AIProfileExtractServiceContext = Depends(get_ai_profile_extract_service),
) -> AIProfileExtractResponse:
    try:
        return await handle_extract_profile(service, payload)
