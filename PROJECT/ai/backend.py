...
from ai_job_search import router as ai_job_search_router
...
default_cors_origins = [] if AI_REQUIRE_AUTH else [
    "http://localhost:3000",
    "http://localhost:5173",
    "http://localhost:8081",
...
async def lifespan(application: FastAPI):
    await initialize_ai_chat_runtime(application)
    yield
    await shutdown_ai_chat_runtime(application)
...
app.include_router(ai_job_search_router)
